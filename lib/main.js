...
exports.Endpoint = exports.defaultErrorSchema = void 0;
const form_data_1 = __importDefault(require("form-data"));
const node_fetch_1 = __importDefault(require("node-fetch"));
const zod_1 = require("zod");
const zodErrorSchema = zod_1.z.custom((value) => {
...
exports.defaultErrorSchema = zod_1.z.object({
    status: zod_1.z.literal(false),
    error: zodErrorSchema.or(zod_1.z.string()),
});
class Endpoint {
    endpoint;
    method;
    ...
    errorSchema;
    headers;
    constructor({ endpoint, method, schema, headers, inputSchema, errorSchema, }) {
